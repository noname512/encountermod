...
public class GremlinWheelGame extends AbstractImageEvent {
    private static final Logger logger = LogManager.getLogger(com.megacrit.cardcrawl.events.shrines.GremlinWheelGame.class.getName());
    public static final String ID = "encountermod:Wheel of Change";
