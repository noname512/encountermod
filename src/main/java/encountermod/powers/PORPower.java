...
public class PORPower extends AbstractPower {
    ...
    public PORPower(AbstractCreature owner) {
        ...
        list.add(new Empty());
        list.add(new Empty());
        region128 = new TextureAtlas.AtlasRegion(ImageMaster.loadImage("resources/encountermod/images/powers/PORPower 84.png"), 0, 0, 84, 84);
        region48 = new TextureAtlas.AtlasRegion(ImageMaster.loadImage("resources/encountermod/images/powers/PORPower 32.png"), 0, 0, 32, 32);
        updateDescription();
    }
